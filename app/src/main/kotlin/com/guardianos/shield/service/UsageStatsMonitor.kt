...
class UsageStatsMonitor(
    ...
    private fun showAppBlockedByScheduleNotification(appName: String) {
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setStyle(NotificationCompat.BigTextStyle()
                .bigText("$appName está bloqueada fuera del horario permitido.\n\nRevisa la configuración de horarios en el Control Parental."))
    ...
    private fun showBlockedByScheduleNotification(appName: String) {
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setStyle(NotificationCompat.BigTextStyle()
                .bigText("No puedes usar $appName ahora mismo.\n\nRevisa el horario permitido en la configuración."))
    ...
    private fun showCriticalBlockNotification(appName: String) {
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setContentText("$appName no está permitida")
            .setStyle(NotificationCompat.BigTextStyle()
    ...
    private fun showBypassToolDetectedNotification(appName: String) {
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setStyle(NotificationCompat.BigTextStyle()
                .bigText("⚠️ El menor intentó abrir: $appName\n\nEsta app puede usarse para eludir los filtros parentales. GuardianOS la ha bloqueado automáticamente y se ha registrado en el historial."))
            .setPriority(NotificationCompat.PRIORITY_MAX)
            .setCategory(NotificationCompat.CATEGORY_ALARM)
